...
// Strict limiter for auth endpoints (Disabled for testing)
export const authLimiter = (req: any, res: any, next: any) => next();

// Limiter for ad generation (Disabled for testing)
export const adGenerationLimiter = (req: any, res: any, next: any) => next();
